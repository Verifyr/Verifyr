...
class DiscordBot {
  constructor () {
    this.initialize()
    this.servers = {}
    this.authorizedOwners = ["756511342399324222"]
  ...
  ready () {
    ...
    this.bot.user.setActivity('mysystems.tk/verifyr', { type: "LISTENING" })
  }
