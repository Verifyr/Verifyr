...
class Command extends Commando.Command {
  ...
  hasPermission (msg) {
    return this.client.isOwner(msg.author) || !msg.guild || msg.member.hasPermission(this.userPermissions) || msg.member.roles.cache.find(role => role.name === 'Verifyr Admin')
  }
