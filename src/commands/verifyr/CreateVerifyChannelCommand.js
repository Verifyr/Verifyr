...
class CreateVerifyChannelCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      aliases: ['verifyrcreateverifychannel', 'createverify', 'createverificationchannel', 'createverification', 'createverifychannels'],
  ...
  async fn (msg) {
    try {
      ...
      msg.reply(':no_entry_sign: Verifyr does not have permission to create channels in this server.')
    }
  }
}
