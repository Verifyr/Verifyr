...
class BindGroupCommand extends Command {
  constructor (client) {
    super(client, {
      name: 'bindrank',
      properName: 'BindRank',
      aliases: ['verifyrbindgrouprank', 'bindgroup', 'bindgrouprank', 'verifyrbind', 'bind'],
  ...
  async fn (msg, args) {
    ...
    if (this.server.server.me.roles.highest.comparePositionTo(args.role) < 0) return msg.reply('You have attempted to bind a role above the Verifyr role, please move `Verifyr` up in your role list and try again.')
