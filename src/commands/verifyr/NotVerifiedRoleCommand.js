...
class NotVerifiedRoleCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      aliases: ['verifyrverifiedremovedrole', 'verifiedremovedrole', 'verifyrnotverifiedrole', 'notverifiedrole'],
  ...
  async fn (msg, args) {
    ...
    if (role) {
      ...
      if (this.server.server.me.roles.highest.comparePositionTo(role) < 0) return msg.reply('You have attempted to bind a role above the Verifyr role, please move `Verifyr` up in your role list and try again.')
