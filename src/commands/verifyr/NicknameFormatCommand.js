...
class NicknameFormatCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      aliases: ['verifyrnicknameformat'],
      description: "`<format>` Set the format Verifyr will use when setting users' nicknames. Available replacements are %USERNAME%, %RANK%, %USERID%, %SERVER%, %DISCORDNAME%, and %DISCORDID%. Example:` %USERNAME% - (%USERID%)`. Default `%USERNAME%`.",
